...
def intersection(list1, list2):
    #intercessao entre duas listas
    return list(set(list1).intersection(set(list2)))


def swap(a, b, l):
    #troque um elemento de indice a por um elemento de indice b em uma lista l   
    l[b], l[a] = l[a], l[b]
    return l
...
def genetic(max_stagnation=4, population_size=10):
    ...
    print("")
    print('Path Cost:', population.best().fitness())
